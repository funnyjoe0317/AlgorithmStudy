...
// path는 tiny의 filename과 같다.
// ex. uri = http://localhost:5000/home.html
// ex. uri = http://www.naver.com
// ex. uri = www.naver.com
// ex. uri = http://localhost
void parse_uri(char *uri, char *hostname, char *path, int *port) {
    *port = 5000;                                                                             // HTTP 기본 포트 설정 값
    char* pos = strstr(uri, "//");
    ...
    // ex. pos = localhost:5000/home.html
    // ex. pos2 = :5000/home.html
    if (pos2 != NULL) {
        *pos2 = '\0';                                                                       // localhost\05000/home.html
        sscanf(pos, "%s", hostname);                                                        // hostname = localhost
